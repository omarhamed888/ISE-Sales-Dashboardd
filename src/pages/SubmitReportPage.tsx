                ...
                <div className="flex justify-between w-full items-center mb-4">
                    ...
                    <button onClick={() => {
                      const samples: Record<string, string> = {
                        "واتساب": `(45) ليد\n\nتوزيع الإعلانات:\n\n1. مردش بعد التفاصيل (20):\naعلان عايز تحترف AI: (الوظائف: مدرس، محاسب، موظف حكومي، مهندس)\naعلان ليه الشركات بتعين مهندسين: (الوظائف: مهندس، خريج جديد، طالب دراسات عليا)\n\n2. مردش بعد السعر (15):\naعلان عايز تحترف AI: (الوظائف: محاسب، موظف، مدرس)\naعلان ليه الشركات بتعين مهندسين: (الوظائف: مهندس ميكانيكا، خريج)\n\n3. رد بعد السعر (10):\naعلان عايز تحترف AI: (الوظائف: مدرس، محاسب | الحالة: هيفكر ويرد، طالب تقسيط)\naعلان ليه الشركات بتعين مهندسين: (الوظائف: مهندس | الحالة: محتاج يتكلم مع مراته)\n\nأسباب الرفض: (سعر عالي: 8 - فاكرها وظيفة: 4 - غير مهتم: 3)\nملاحظات: (إعلان المهندسين بيجيب ناس مش مؤهلين، ممكن نراجع التارجيتينج)\n\nالمبيعات المغلقة (Sales):\nمحمد علي | اعلان عايز تحترف AI | AI Diploma | 8000 | 2026-04-08\nكريم سامي | اعلان ليه الشركات بتعين مهندسين | AI + Sales Bundle | 12000 | 2026-04-07`,
                        "تيك توك": `(30) ليد\n\nتوزيع الإعلانات:\n\n1. مردش بعد التفاصيل (12):\naعلان عايز تحترف AI: (الوظائف: طالب، موظف، فريلانسر)\naعلان ليه الشركات بتعين مهندسين: (الوظائف: مهندس، خريج)\n\n2. مردش بعد السعر (10):\naعلان عايز تحترف AI: (الوظائف: موظف، طالب)\naعلان ليه الشركات بتعين مهندسين: (الوظائف: مهندس)\n\n3. رد بعد السعر (8):\naعلان عايز تحترف AI: (الوظائف: فريلانسر، طالب | الحالة: هيحضر أونلاين، عايز يعرف الجدول)\naعلان ليه الشركات بتعين مهندسين: (الوظائف: مهندس | الحالة: هيفكر)\n\nأسباب الرفض: (سعر عالي: 5 - فاكرها وظيفة: 3 - غير مهتم: 2)\nملاحظات: (كتير مش فاهمين الكورس هو ايه، لازم فيديو توضيحي)\n\nالمبيعات المغلقة (Sales):\nأحمد حسن | اعلان عايز تحترف AI | AI Diploma | 8000 | 2026-04-09`,
                        "ماسنجر": `(38 رسالة - 60 كومنت)\n\n━━━ رسائل (38) ━━━\n\nمردش بعد أهلاً (10): (اعلان عايز تحترف AI: 6 | اعلان ليه الشركات بتعين مهندسين: 4)\n\nمردش بعد التفاصيل (14):\n(اعلان عايز تحترف AI / مدرس)\n(اعلان عايز تحترف AI / محاسب)\n(اعلان عايز تحترف AI / موظف حكومي)\n(اعلان ليه الشركات بتعين مهندسين / مهندس)\n(اعلان ليه الشركات بتعين مهندسين / خريج جديد)\n\nمردش بعد السعر (9):\n(اعلان عايز تحترف AI / محاسب)\n(اعلان عايز تحترف AI / موظف حكومي)\n(اعلان ليه الشركات بتعين مهندسين / مهندس ميكانيكا)\n\nرد بعد السعر (5):\n(اعلان عايز تحترف AI / مدرس / هيفكر ويرد)\n(اعلان عايز تحترف AI / محاسب / عايز يقسط)\n(اعلان ليه الشركات بتعين مهندسين / مهندس / محتاج يتكلم مع مراته)\n\nحالات خاصة: (حسابات وهمية / اعلان عايز تحترف AI)\n\n━━━ كومنتات (60) ━━━\n\nمردش بعد أهلاً (20): (اعلان عايز تحترف AI: 12 | اعلان ليه الشركات بتعين مهندسين: 8)\n\nمردش بعد التفاصيل (18):\n(اعلان عايز تحترف AI / مدرس)\n(اعلان عايز تحترف AI / طالب جامعة)\n(اعلان ليه الشركات بتعين مهندسين / مهندس)\n(اعلان ليه الشركات بتعين مهندسين / خريج)\n\nمردش بعد السعر (12):\n(اعلان عايز تحترف AI / موظف)\n(اعلان ليه الشركات بتعين مهندسين / مهندس مدني)\n\nرد بعد السعر (10):\n(اعلان عايز تحترف AI / مدرس / هيفكر)\n(اعلان عايز تحترف AI / محاسب / عايز يعرف الجدول)\n(اعلان ليه الشركات بتعين مهندسين / مهندس / طالب تقسيط)\n\nحالات خاصة: (كومنت سلبي على الإعلان / اعلان ليه الشركات بتعين مهندسين)`,
                      };
